...
function FlightRecords() {
    ...
    const{
        ...
        seatCount,setSeatCount,setSeatAdultCount,seatChildrenCount,setSeatChildrenCount,seatInfantCount,setSeatInfantCount
    } = useAuth();
    ...
    const CustomInput = ({value,onclick})=>{
        <input
        type="text"
        className={Classes.inputFlightRecor}
    ...
    const incrementAdultSeatCount = () =>{
        setSeatCount((prevCount)=>prevCount+1);
        setSeatAdultCount((prevCount)=> prevCount+1);
    };

    const decrementAdultSeatCount = () =>{
        setSeatCount((prevCount)=>(prevCount>1 ? prevCount-1 : 1));
        setSeatAdultCount((prevCount)=>(prevCount>1 ? prevCount-1 : 1));
    ...
    async function handleSearch(){
        try{
            ...
            setErrorPost("An error occured. Please try again");
        }
        useEffect(()=>{
            handleSearch();
  ...
  return (
    <div>
        <Navbar/>
        <div className={Classes.fligtSearchSection}>
            <div className={Classes.searchBarFlight}>
                ...
                {flightRecordToOpen && <FlightTo onclose={handleFlightToOpen}/>}
                <div className="flex justify-center items-center h-[100%] w-[17px] max-[600px]:w-[100%] max-[600px]:border-solid max-[600px]:border-[#e0dede] max-[600px]:rounded-[5px]">
                ...
                <div className="flex justify-center items-center h-[100%] w-[17px] max-[600px]:w-[100%] max-[600px]:border-solid max-[600px]:border-[#e0dede] max-[600px]:rounded-[5px]">
                    <div onClick={handleFlightTraveller} className="w-[95%] h-[90%] flex flex-col gap-[5px]">
                        ...
                        <div className="flex justify-evenly items-center">
                            ...
                            <span className="text-[13px] font-[600] text-[#fff]">Traveller(s)</span>
                ...
                <div className="w-[15%] max-[600px]:w-[75%] h-[55 absolute bg-slate-50 lg:mt-16 mt-[16em] p-2 rounded lg:ml-[55em] ml-[0] z-10 shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
                    <div className="w-[98%] flex flex-col gap-[5px]">
                        <div className="w-[100%] flex mb-[15px] mt-[5px] justify-between items-center">
                            <div className="flex flex-col justify-center">
                                <p className="text-[13px] text-[#ooo] font-[600]">Adults</p>
                                <p className="text-[11px]">(12+ Years)</p>
                            </div>
                            <div className="rounded-[4px] border border-[#dcdcdc] border-solid flex items-center">
                                <button className="w-[26px] h-[31px] border-[0] text-[18px] cursor-pointer text-[#000]" onClick={decrementAdultSeatCount} disabled={seatAdultsCount <= 1}>-</button>
                                <input className={Classes.travellerInput} type="text" value={seatAdultsCount} readOnly/>
                                <button className="w-[26px] h-[31px] border-[0] text-[18px] cursor-pointer text-[#000]" onClick={incrementAdultSeatCount} disabled={seatAdultsCount >= 9}>+</button>
                            </div>
                        </div>
                    ...
                    <div className="w-[100%] flex mb-[15px]  justify-between items-center">
                            <div className="flex flex-col justify-center">
                                <p className="text-[13px] text-[#ooo] font-[600]">Children</p>
                                <p className="text-[11px]">(2-12 Years)</p>
                            </div>
                            <div className="rounded-[4px] border border-[#dcdcdc] border-solid flex items-center">
                                <button className="w-[26px] h-[31px] border-[0] text-[18px] cursor-pointer text-[#000]" onClick={decrementChildrenSeatCount} disabled={seatChildrenCount <= 1}>-</button>
                        ...
                        <div className="w-[100%] flex mb-[15px]  justify-between items-center">
                            <div className="flex flex-col justify-center">
                                <p className="text-[13px] text-[#ooo] font-[600]">Infant</p>
                                <p className="text-[11px]">(0-2 Years)</p>
                            </div>
                            <div className="rounded-[4px] border border-[#dcdcdc] border-solid flex items-center">
                                <button className="w-[26px] h-[31px] border-[0] text-[18px] cursor-pointer text-[#000]" onClick={decrementInfantSeatCount} disabled={seatInfantCount <= 1}>-</button>
          ...
          <div className="w-[80%] h-[100%] flex flex-row gap-[20px]">
            <div className={Classes.filterSideBar}>
               <div className={Classes.flightDataPage}>
                 <div className="text-[#000] text-[14px] font-6[600]">
                    <p> FILTER </p>
                 </div>
                ...
                <div className="mt-[30px]">
                    ...
                    <div className="w-[100%]">
                        <div className="w-[100%] border border-solid border-[3e0e0e0] bg-[#fff] mt-[5px] rounded-[5px] flex">
                            ...
                            onClick={()=>handleClickSet("depatureTime","$lt", "6")}
                            >
                            ...
                            <div
                            className="w-[25%] border border-solid border-[#e0e0e0] cursor-pointer flex flex-col justify-center items-center"
                            onClick={()=>handleClickSet("depatureTime","$lte", "12")}
                            >
                            ...
                            <div
                            className="w-[25%] border border-solid border-[#e0e0e0] cursor-pointer flex flex-col justify-center items-center"
                            onClick={()=>handleClickSet("depatureTime","$gte", "18")}
                            >
