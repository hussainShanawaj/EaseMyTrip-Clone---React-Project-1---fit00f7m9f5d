...
function HotelDetail() {
  ...
  // Fetch hotel data on component mount or when hotelId changes
  useEffect(() => {
  ...
  // Function to handle booking a hotel room
  ...
  return (
    <div>
      ...
      {/* Hotel search bar component */}
      <HotelSearchbar />
      
      {/* Main hotel detail section */}
      <div className={Classes.hotelDetailMainDiv}>
        <div className={Classes.hotelDetailInfoSection}>
          <div className={Classes.hotelDetailMainInfo}>
            <div className={Classes.hotelDetailHeaders}>
              ...
              <div className={Classes.hotelDetailName}>
                ...
                <p className="text-[13px] font-medium	text-[#9F9C9C] ">
                  <img src="https://www.easemytrip.com/Hotels/img/map-marker.svg"/> {hotelDetailData.location}
                </p>
              </div>
              {/* Hotel rating */}
            ...
            {/* Hotel images and price section */}
