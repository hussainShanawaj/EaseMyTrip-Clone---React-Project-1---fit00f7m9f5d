  ...
  return (
    <div>
        ...
        <div className={Classes.hotelDetailMainDiv}>
            <div className={Classes.hotelDtailInfoSection}>
                <div className={Classes.hotelDetailMainInfo}>
                    <div className={Classes.hotelDettailHeaders}>
                        <div className={Classes.hotelDetailHeaders}>
                            <div className={Classes.hotelDetailName}>
                                ...
                                <p className="text-[13px] font-medium text-[#9F9C9C]">
                                    <img src="https://www.easemytrip.com/Hotels/img/map-marker.svg"/>
                                    {hotelDetailData.location}
                                </p>
                        ...
                        <div className={Classes.hotelDetailImgPriceSection}>
                            <div className={Classes.hotelDetailImageSection}>
                                <div className={Classes.hotelMainImage}>
                                    <img className="w-[100%] h-[100%] object-cover" src={hotelDetailData?.images?.[0]}/>{hotelDetailData.location}
                                </div>
                                <div className={Classes.hotelOtherImage}>
                                    <div className={Classes.hotelIamgeSample1}>
                                        <img className="w-[100%] h-[100%] object-cover" src={hotelDetailData?.images?.[1]}/>
                                    </div>
                                    <div className={Classes.hotelIamgeSample2}>
                                        <img className="w-[100%] h-[100%] object-cover" src={hotelDetailData?.images?.[2]}/>
                                    </div>
                                    <div className={Classes.hotelIamgeSample3}>
                            ...
                            <div className={Classes.hotelDetailPriceSection}>
                                ...
                                <div className="w-[50%] h-[100%] flex flex-col">
                                    <div className="flex ml-[2px] mt-[10px] items-center gap-[5px]">
                                        ...
                                        <p className="text-[17px] font-[600] text-[#44DCB]">
                                            {hotelDetailData?.rooms?.[0].roomType}
                                        </p>
                                    </div>
                                ...
                                <div className="w-[50%] h-[100%]">
                                    <div className="mt-[10px] flex items-center justify-end gap-[1px] w-[100%] h-[5vh] text-[24px] font-[600]">
                                        ...
                                        <p className="mr-[2px]">
                                            {hotelDetailData?.rooms?.[0].costPerNight}
                                        </p>
                                    </div>
                                ...
                                <div className="w-[100%] h-[15%] flex">
                                    <div className={Classes.hotelDetailCheckIn}>
                                        ...
                                        <span className="text-[14px] text-[#2196f3] font- medium ml-[4px] ">CHECK-IN: </span>
                                    </div>
                                    <div className={Classes.hotelDetailCheckOut}>
                                        <img src="https://www.easemytrip.com/Hotels/img/calendar_icon.svg"/>
                                        <span className="text-[14px] text-[#2196f3] font- medium ml-[4px] ">CHECK-OUT: </span>
                                    </div>
                                </div>
                                <Divider flexItem/>
                                ...
                                <div className={"w-[100%] h-[20%] flex justify-between items-center" }>
                                    <div className="w-[47%] h-[70%] border hover:bg-[#da5200] bg-[#EF6614] text-[#fff] border-[#EF6614] border-500 border-solid flex justify-center items-center hover:text-[#fff] rounded-[40px] font-[600] text-[15px] ccursor-pointer " onClick={()=> handleBookFlight(hotelDetailData._id)}>
                                        <div>
                                            <p>Book Now</p>
                                        </div>
                                    </div>
                    ...
                    <div className="w-[100%] h-[6vh] flex bg-[#feecde] text-[13px] font-medium">
                        ...
                        <div className="w-[100%] h-[100%] flex flex-col">
                            {hotelDetailData.rooms?.map((room,index)=>(
                                <div className="border border-solid border-[$feecde] w-[100%] h-[40%] flex" key={index}>
                                  <div className="w-[95%] h-[95%] flex flex-col gap-[10px]">
                                    ...
                                    <div className="w-[100%] h-[70%] rounded-[5px]">
                                        <img className="w-[100%] h-[100%] object-cover rounded-[5px]" src={hotelDetailData?.image?.[0]}/>
                                ...
                                <div className="h-[100%] w-[30%] border border-[#feecde] border-solid flex justify-center items-center">
                                    <div className="w-[95%] h-[95%]">
                                        <div className="w-[100%] h-[15%] flex items-center gap-[5px]">
                                            <p className="w-[4px] h-[18px] rounded-[3px] bg-[#0c6be9]"></p>
                                            <p className="text-[14px] font-[600] text-[#000]">Room Only</p>
                                        </div>
                                        <div className="w-[100%] h-[50%]">
                                            <div className="ml-[10px] h-[30%] text-[#000] flex gap-[5px] items-center">
                                ...
                                <div className="h=[100%] w-[45%] flex items-center gap-[15px]">
                                    <div className="h-[95%] w-[60%] flex">
                                        <div className="h-[100%] w-[20%]">
                                            <img className="w-[60%]" src="https://hotel.easemytrip.com/Images/Hotel/icon/recommded-3.svg"/>
                                        ...
                                        <div className="w-[80%] h-[60%]">
                                            ...
                                            <div className="flex items-center justify-end text-[12px] font-[600] w-[100%] h-[20%]">
                                              <p>+</p>
                                              <img className={Classes.resIconHotel} src="https://hotels.easemytrip.com/newhotel/Content/img/rupee_new_black.svg"/>
                                              <p className="mr-[2px]">{room?.costDetails.taxesndFees} Taxes & fees</p>
                                            </div>
                                    ...
                                    <div className="h-[95%] w-[37%] flex justify-center">
                                        <div className="w-[90%] h-[20%]">
                                            <p className="text-[15px] text-[#fff] bg-[#rf6614] h-[80%] border-[#EF6614] font-[600] rounded-[50px] cursor-pointer flex items-center justify-center mt-[10px]  " onClick={()=>handleBookFlight(hotelDetailData._id)}>Book Now</p>
                                        </div>
                                    </div>
                                </div>
                                </div>
